...
/**
 * REST controller for managing {@link com.barsa.domain.Producto}.
 */
@RestController
@RequestMapping("/api")
public class ProductoResource {
    ...
    public ResponseEntity<List<Producto>> getAllProductos(ProductoCriteria criteria, Pageable pageable) {
